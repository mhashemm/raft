...
const (
	Raft_RequestVote_FullMethodName         = "/main.raft/RequestVote"
	Raft_AppendEntries_FullMethodName       = "/main.raft/AppendEntries"
	Raft_LeaderAppendEntries_FullMethodName = "/main.raft/LeaderAppendEntries"
)
...
type RaftClient interface {
	...
	LeaderAppendEntries(ctx context.Context, in *AppendEntriesRequest, opts ...grpc.CallOption) (*AppendEntriesResponse, error)
}
...
func (c *raftClient) LeaderAppendEntries(ctx context.Context, in *AppendEntriesRequest, opts ...grpc.CallOption) (*AppendEntriesResponse, error) {
	out := new(AppendEntriesResponse)
	err := c.cc.Invoke(ctx, Raft_LeaderAppendEntries_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RaftServer interface {
	...
	// called by clients to the leader
	LeaderAppendEntries(context.Context, *AppendEntriesRequest) (*AppendEntriesResponse, error)
}
...
func (UnimplementedRaftServer) LeaderAppendEntries(context.Context, *AppendEntriesRequest) (*AppendEntriesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LeaderAppendEntries not implemented")
}
...
func _Raft_LeaderAppendEntries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AppendEntriesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RaftServer).LeaderAppendEntries(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Raft_LeaderAppendEntries_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServer).LeaderAppendEntries(ctx, req.(*AppendEntriesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Raft_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "LeaderAppendEntries",
			Handler:    _Raft_LeaderAppendEntries_Handler,
		},
	},
